...
#define HAB_RVT_BASE                0x1C000500

#define HAB_RVT_ENTRY			    ((unsigned long)*(uint32_t *)(HAB_RVT_BASE + 0x04))
#define HAB_RVT_EXIT		    	((unsigned long)*(uint32_t *)(HAB_RVT_BASE + 0x08))
#define HAB_RVT_AUTHENTICATE_IMAGE	((unsigned long)*(uint32_t *)(HAB_RVT_BASE + 0x10))
#define HAB_RVT_REPORT_EVENT		((unsigned long)*(uint32_t *)(HAB_RVT_BASE + 0x20))
#define HAB_RVT_REPORT_STATUS		((unsigned long)*(uint32_t *)(HAB_RVT_BASE + 0x24))


#define SECURE_BOOT_BIT             0x80000000

#define OCOTP_BASE_ADDR             0x410A6000

#define SEC_CONFIG1                 (OCOTP_BASE_ADDR + 0x12E0)
